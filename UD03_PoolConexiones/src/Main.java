...
public class Main {
	...
	public static void main(String[] args) throws SQLException {
		String url ="jdbc:mysql://localhost:" + 3306 + "/" + "baloncesto" + "?useSSL=false" + "&serverTimezone=CET";
			...
			System.out.println("Tama�o Pool conexiones: " + connectionPool.getConnectionPool().size());
