...
/**
 * Clase que implementa un m�todo est�tico para convertir una fecha pasada como
...
public class dateToSqlDate {
	 ...
	 * devuelve un java.sql.Date. En caso de no recibir un formato v�lido para la
	 * transformaci�n devuelve un error.
	 * 
