...
public class MainCreacion {
	...
	public static void main(String[] args) throws ParseException {
		...
		HashSet<EmpleadoEntity>empleadosd1= new HashSet<EmpleadoEntity>();
		...
		empleadosd1.add(e1); empleadosd1.add(e2); empleadosd1.add(e3);
		d1.setEmpleados(empleadosd1);
		
		HashSet<EmpleadoEntity>empleadosd2= new HashSet<EmpleadoEntity>();
		...
		empleadosd2.add(e4); empleadosd2.add(e5); empleadosd2.add(e6);empleadosd2.add(e7); empleadosd2.add(e8); 
		d2.setEmpleados(empleadosd2);
		
		HashSet<EmpleadoEntity>empleadosd3= new HashSet<EmpleadoEntity>();
		...
		empleadosd3.add(e9); empleadosd3.add(e10); empleadosd3.add(e11);empleadosd3.add(e12); empleadosd3.add(e13); empleadosd3.add(e14); 
		d3.setEmpleados(empleadosd3);
