...
public class MainCreacion {
	...
	public static void main(String[] args) {
		...
		//
		Familia f1 = new Familia("CAMARA", "Cámaras digitales");
		Familia f2 = new Familia("CONSOL", "Consolas");
		Familia f3 = new Familia("EBOOK", "Libros electrónicos");
