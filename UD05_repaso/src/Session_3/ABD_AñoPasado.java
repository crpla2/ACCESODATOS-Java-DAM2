...
//		---------------------------------------------
//		Ejercicio 2 �dem de la anterior pero para aquellos que "Carrera" forma parte del nombre. No distinguir may�sculas de min�sculas
...
//		Ejercicio 5 Empleados por orden alfab�tico de departamento
...
//		Ejercicio 6 Nombre, n� de empleados, total y m�ximo salario de los departamentos con empleados
...
//		Ejercicio 8 Cada empleado junto con su jefe
		TypedQuery<Object[]> tq8 = em.createQuery(
			...
			Object[].class);
//		Ejercicio 9 Nombre y total de empleados de los departamentos con alg�n empleado
...
//		Ejercicio 12 Empleados sin jefe
		TypedQuery<Object[]> tq12 = em.createQuery("SELECT d.salario, d.nombre FROM EmpleadoEntityEj d  where d.dirId is null"
				,
				Object[].class);
//		Ejercicio 13 Departamento al que pertenece el empleado n� 1039
